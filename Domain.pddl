...
(:predicates (at_kitchen_bread ?b - bread-portion)
	     (at_kitchen_content ?c - content-portion)
			 ...
			 (vegan_bread ?b - bread-portion)
			 (vegan_no_gluten_bread ?b - bread-portion)
       	     (no_gluten_content ?c - content-portion)
			 (vegan_content ?c - content-portion)
			 (vegan_no_gluten_content ?c - content-portion)
      	     (ontray ?s - sandwich ?t - tray)
       	     (no_gluten_sandwich ?s - sandwich)
			 (vegan_sandwich ?s - sandwich)
			 (vegan_allergic_gluten_sandwich ?s - sandwich)
...
(:action make_sandwich_vegan 
	 :parameters (?s - sandwich ?b - bread-portion ?c - content-portion)
	 :precondition (and (at_kitchen_bread ?b)
			    (at_kitchen_content ?c)
			    (or (vegan_bread ?b)
					(vegan_no_gluten_bread ?b))
			    (or (vegan_content ?c)
					(vegan_no_gluten_content ?c))
			    (notexist ?s))
	 :effect (and
		   (not (at_kitchen_bread ?b))
		   (not (at_kitchen_content ?c))
...
(:action make_sandwich_vegan_no_gluten 
	 :parameters (?s - sandwich ?b - bread-portion ?c - content-portion)
	 :precondition (and (at_kitchen_bread ?b)
			    (at_kitchen_content ?c)
			    (vegan_no_gluten_bread ?b)
	 ...
	 :effect (and
		   ...
		   (not (at_kitchen_content ?c))
		   (at_kitchen_sandwich ?s)
		   (vegan_allergic_gluten_sandwich ?s)
                   (not (notexist ?s))
		   ))
...
(:action serve_sandwich_vegan_no_gluten
 	:parameters (?s - sandwich ?c - child ?t - tray ?p - place)
	:precondition (and
		       (vegan_allergic_gluten ?c)
		       (ontray ?s ?t)
		       (waiting ?c ?p)
		       (vegan_allergic_gluten_sandwich ?s)
                       (at ?t ?p)
